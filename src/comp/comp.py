...
c = [name.name for name in humans if name.name[0] == 'C' or name.name[0] ==
     'D' or name.name[0] == 'E' or name.name[0] == 'F' or name.name[0] == 'G']
print(c)
...
g = [list(chain(human.name.upper(), human.age + 5)) for human in humans]
print(g)
